...
Vex.Flow.Note = (function() {
  ...
  //ARKADY - note struct also now has a color field
  //
...
Vex.Flow.StaveNote = (function() {
  ...
  Vex.Inherit(StaveNote, Vex.Flow.StemmableNote, {
    init: function(note_struct) {
      ...
      this.beam = null;
      //ARKADY - define new property 'color'
      if (typeof note_struct.color !='undefined') 
    ...
    draw: function() {
      ...
      // ARKADY - get fill style back to original color!
