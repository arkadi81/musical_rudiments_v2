moduleDOMConstructor = function(moduleNumber) {
	...
	document.getElementById('module'+ moduleNumber+'body').innerHTML += '<div class="flex-container text-center" id="module' + moduleNumber + 'Container" ></div>'; //20180811
		...
		for (i=0; i<moduleOptions[moduleNumber].totalQuestions();i++) {
			...
			switch (moduleNumber) {
				...
				default: {
					...
					// '</div>',
					// '<div class="row text-center screen-canvas-div">',
					// 	'<canvas class="triad-canvas" height=' + h + ' width=' + w + ' id="module' + moduleNumber + 'Canvas'+i+'"></canvas>',
					// '</div>',
					// '<div class="row text-center">',
					...
					// ATTEMPT AT MAKING THIS RESPONSIVE BY INTRODUCING FLEX AND REMOVING BOOTSTRAP GRID

					document.getElementById('module'+moduleNumber+'Question'+i).innerHTML+= [
					//'<table class="table" text-center>',
					'<div class="">',
						'<div class="" id="module'+moduleNumber+'Question' + i + 'Prompt"></div>',
					'</div>',
					'<div class="screen-canvas-div">',
						'<canvas class="" ' + ' id="module' + moduleNumber + 'Canvas'+i+'"></canvas>',
					'</div>',
					'<div class="">',
						'<canvas class="print-only-canvas" ' + ' id="module' + moduleNumber + 'Canvas'+i+'printable"></canvas>',
					'</div>',
					'<div class="">',
						'<div class="" id="module'+moduleNumber+'Question' + i + 'LowerPrompt"></div>',
					'</div>',
					...
					'</div>',
					'<div class="row text-center row-bottom-border">',
						'<div class="answer_check" id="module'+moduleNumber+'Answer'+ i +'"></div>',
						'<div class="answer_check" id="module'+moduleNumber+'Check'+ i +'"></div>',
					'</div>'
					].join('');

					// -------------------------- end of responsive attempt ---------------------
...
submit = function(showreport=true) {
